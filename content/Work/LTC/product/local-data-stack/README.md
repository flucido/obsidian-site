...
`local-data-stack` is an open-source, local-first analytics working model for education data. It combines Python orchestration, DuckDB, Delta/Parquet staging, dbt transformations, and Rill dashboards so contributors can explore the architecture without depending on cloud services or private student records.

It's intentionally exploratory — designed less as a finished product and more as a way to engage with the ideas: how data flows through a district, what transformations matter, and what dashboards actually tell you something useful. The focus is on accessibility and intuition rather than technical completeness.
...
https://github.com/flucido/local-data-stack
