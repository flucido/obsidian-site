...
### For Clients
- Your users are not neutral. They are seeking help, processing difficulty, or making important decisions.
- Standard web design assumes cognitive availability your users may not have.
- We design from evidence about how brains actually respond to interfaces.
- You will receive not just a website, but proof that it works for your users.

### For the Industry
- Conversion without trust is extraction.
- Design that works for the most vulnerable works for everyone.
- Evidence is not the enemy of creativity — it is its foundation.

## What We Say No To
- Clients who want urgency-based conversion tactics
- Projects that serve industries we cannot ethically support
- Work that requires dark patterns or manipulative design
- "Make it look like [competitor]" without understanding why
